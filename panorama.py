...
def convert_3_classes(layout):
    ...
    _layout[layout==2]=1;_layout[layout==3]=2;_layout[layout==1]=0 
    return _layout
...
def VizWithClasses(mask_np):
    h,w = mask_np.shape[:2]
    viz = np.zeros((h,w,3))
    viz[mask_np==0,:] = (0,0,255)      #ceiling: red
    viz[mask_np==1,:] = (255,0,0)      #floor: blue
    viz[mask_np==2,:] = (0,255,0)  #wall: green
    return viz
