...
def parseArguments():
    ...
    parser.add_argument('--segmentation_model_chkpnt', type = str, default = 'https://github.com/VasilisGks/IndoorDR-Web-App/releases/download/v1.0.0/Unet_epoch23.zip', help = 'Save checkpoints here')
    parser.add_argument('--eval_chkpnt_folder', type=str, default='https://github.com/VasilisGks/IndoorDR-Web-App/releases/download/v1.0.0/57_net_G.zip')
