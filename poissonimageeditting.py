...
def poisson_blend(src, mask, tar, method, output_dir=None):
  ...
  ### fill A
  #logger.info("step1: filling coefficient matrix: A")
  ...
  #     print("\n")
  #Replaced the above lines
  A = coefficient_matrix(omega, mask, ngb_flag, yx_omega)


  ### fill u
  ### --> each color channel
  #logger.info("step2: filling gradient matrix: b")
